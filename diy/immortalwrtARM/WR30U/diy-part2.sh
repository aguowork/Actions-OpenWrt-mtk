...
# 修改闭源驱动2G wifi名称
sed -i 's/ImmortalWrt-2.4G/H/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh

# 修改闭源驱动5G wifi名称
sed -i 's/ImmortalWrt-5G/H/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
...
sed -i -e 's/#jk~(sleep 500;/(sleep 500;/g' -e 's/jkwr30u/jkwr30u/g' files/etc/rc.local
...
git clone https://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:x-oauth-basic@github.com/aguowork/luci-app-wechatpush feeds/luci/applications/luci-app-wechatpush
